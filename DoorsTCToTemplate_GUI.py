...
import DoorsTCToTemplate_Script
...
class TestScript:
    def RunTest():
        DoorsTCToTemplate_Script.startFun(filepath,filepath_temp,TkObject_ref)

#def DoorsTPToTemplate():
def DoorsTCToTemplateConv():
       ...
       root.title('Welcome to Doors TC to xlsx Template conversion Tool')
