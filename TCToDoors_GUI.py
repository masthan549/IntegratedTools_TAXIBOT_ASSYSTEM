...
class TestScript:
    def RunTest():
        TCToDoors_Script.startFun(filepath,filepath_temp,TkObject_ref)

def TCTemplateToDoors():	
       ...
       root.title('Welcome TC Template to Doors conversion Tool')
